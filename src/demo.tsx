...
// These two prop definitions are to create two window-shades for our
// demo page. For the moment, they both use the brain-dead content block,
// above, to test some markdown examples.
...
// These 3 style definitions are used to simply show every icon that's just
// been imported into the project. Once we have all the SVG conventions
// resolved, they should be deleted, as well as the icon displays in the
// main page. The are purposely rendered in an ugly purple to encourage
// their removal.
